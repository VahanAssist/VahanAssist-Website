                     ...
                     <tbody>
                        ...
                        foreach ($vBookings as $data) { 
                           ...
                           <tr>
                              ...
                              <td>
                                 <a href="<?php echo base_url(); ?>Main_con/inspectionorderdetails/<?php echo $data['id'] ?>" class="mb-2 mr-2 border-0 btn-transition btn btn-outline-danger "><i class="fa fa-eye"></i> </a>
                              </td>
                              <td>
