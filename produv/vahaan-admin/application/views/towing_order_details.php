            ...
            <div class="app-page-title">
                ...
                <div class="page-title-wrapper">
                    ...
                    <div class="page-title-heading">
                        ...
                        <div> Towing Order Details



                            <div class="page-title-subheading"> Towing Order Details
                            ...
                            <div class="col-lg-6 pull-left">
                                ...
                                <div class="position-relative row form-group">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <a target="_blank" href="https://www.google.com/maps?q=<?php echo $getbookingData[0]['droplat'] ?>,<?php echo $getbookingData[0]['droplng'] ?>">View on Map </a>
