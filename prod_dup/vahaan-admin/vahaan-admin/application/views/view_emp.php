   ...
   <div class="app-page-title">
      <div class="page-title-wrapper">
         <div class="page-title-heading">
            ...
            <div>
               Delivery Boys
               <div class="page-title-subheading">View Delivery Boys
               </div>
            </div>
         </div>
      </div>
            ...
            <div class="card-body">
               ...
               $getUser = $this->Manage_product->getUser($data['r_id']);
                    ...
                    <!--     <td><?php echo $getCategory[0]['category_name'] ?></td>
                        ...
                        <!-- <td><?php echo $getUser[0]['shop_name'] ?></td> -->
                    ...
                    <td>
                           <a href="<?php echo base_url(); ?>Main_con/add_emp/<?php echo $data['id'] ?>" class="mb-2 mr-2 border-0 btn-transition btn btn-outline-primary"><i class="fa fa-edit"></i> Edit</a>
