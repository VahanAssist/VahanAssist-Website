               ...
               <table class="mb-0 table">
                  ...
                  <tbody>
                     ...
                     <tr>
                        ...
                        <td>
                        <select name="blocked" class="form-control" onchange="updateBlockStatus('<?php echo $data['id'] ?>')">
                              <option <?php echo  $data['blocked'] == 1 ? 'selected' : '' ?> value="1">Block</option>
                              <option <?php echo $data['blocked'] == 0 ? 'selected' : '' ?> value="0">Unblock</option>
                             </select>
                        </td>
                        <td>
