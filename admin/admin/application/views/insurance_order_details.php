            ...
            <div class="app-page-title">
                ...
                <div class="page-title-wrapper">
                    ...
                    <div class="page-title-heading">
                        ...
                        <div> Insurance Order Details



                            <div class="page-title-subheading"> Insurance Order Details
                    ...
                    <div class="card-body">
                        ...
                        <form method="post" action="" name="updateOrder" enctype="multipart/form-data">
                                    ...
                                    <tr><th>Phone No</th><td><?php echo $getUser[0]['phoneNumber'] ?></td></tr>
                                      <tr>
                                        <td>
                                            ...
                                            <br>
                                            <br>
                                            <a class="hovera" title="click to open in new tab" href="<?php echo base_url('images/vehicle_image/' . $getbookingData[0]['rcFrontUpload']) ?>" target="_blank">
                                                <img src="<?php echo base_url('images/vehicle_image/' . $getbookingData[0]['rcFrontUpload']) ?>" width="100">
                                            </a>
                                        </td>
                                        <td>
                                            <b>RC Image Back</b>
                                            <br>
                                            <br>
                                            <a class="hovera" title="click to open in new tab" href="<?php echo base_url('images/vehicle_image/' . $getbookingData[0]['rcBackUpload']) ?>" target="_blank">
                                            <img src="<?php echo base_url('images/vehicle_image/' . $getbookingData[0]['rcBackUpload']) ?>" width="100">
                                            </a>
                                        </td>
                                    </tr>
                            ...
                            <div class="col-lg-6 pull-left">
                                ...
                                <legend class="col-form-label col-sm-12">Booking Details</legend>


                                <table class="table">
                                    <tr><th>Insurance Type </th><td><?php echo $getbookingData[0]['insuranceType'] ?></td></tr>
                                    <tr><th>Registration No</th><td><?php echo $getbookingData[0]['regNo'] ?></td></tr>
                                    <tr><th>Manufacturing Year</th><td><?php echo $getbookingData[0]['mfgYear'] ?></td></tr>
                                    <tr><th>Chasis No</th><td><?php echo $getbookingData[0]['chasis'] ?></td></tr>
                                    <tr><th>Engine No</th><td><?php echo $getbookingData[0]['engNo'] ?></td></tr>
