                ...
                <div class="card-body">
                    ...
                    <input name="action" id="action" type="hidden" value="admin">
                        ...
                        <div class="position-relative row form-group">
                          ...
                          <div class="position-relative row form-group">
                            <label for="dl" class="col-sm-3 col-form-label">Driver Licence</label>
                            <div class="col-sm-9">
                                <input name="dl" id="dl" placeholder="" type="file" class="form-control" value="">
                            </div>
                        </div>
                        <div class="position-relative row form-group">
                            <label for="aadhar" class="col-sm-3 col-form-label">Aadhaar Card</label>
                            <div class="col-sm-9">
                                <input name="aadhar" id="aadhar" placeholder="" type="file" class="form-control" value="">
                            </div>
                        </div>

                        <div class="position-relative row form-group">
                            <label for="photo" class="col-sm-3 col-form-label">Photo ID</label>
                            <div class="col-sm-9">
                                <input name="photo" id="photo" placeholder="" type="file" class="form-control" value="">
                            </div>
                        </div>
                        <div class="position-relative row form-group">
